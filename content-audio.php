...
$wpex_post_background_color = get_post_meta($post->ID, 'wpex_post_background_color', true);  ?>


<article <?php post_class('blog-entry clearfix');  ?>    style="background-color:<?= $wpex_post_background_color ?>"  >  
	<?php
	// Show Featured Image
